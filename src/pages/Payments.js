...
const PaymentOrder = () => {
    ...
    const checkoutHandler = async (amount) => {
        ...
        const { data: { order } } = await axios.post("https://grocery-store-backend-f67o.onrender.com/api/checkout", {
            amount
        })
        ...
        const options = {
            ...
            order_id: order.id,
            callback_url: "https://grocery-store-backend-f67o.onrender.com/api/paymentverification",
            prefill: {
                name: "Gaurav Kumar",
